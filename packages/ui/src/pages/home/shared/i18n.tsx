...
export const appCopy: Record<ResolvedLanguage, AppCopy> = {
  en: {
    ...
    text: {
      ...
      "Bypass global proxy": "Bypass global proxy",
      "When enabled, requests to this provider bypass the global upstream proxy and connect directly.": "When enabled, requests to this provider bypass the global upstream proxy and connect directly.",
  ...
  zh: {
    ...
    text: {
      ...
      "When enabled, requests to this provider bypass the global upstream proxy and connect directly.": "启用后，发往该供应商的请求将绕过全局上游代理直接连接。",
